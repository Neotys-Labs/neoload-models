...
public class WebAddCookieTest {
	...
	public static final MethodCall WEB_ADD_COOKIE_TEST = ImmutableMethodCall.builder()
			.name("\"web_add_cookie\"")
			.addParameters("\"NID=131=IGM2b3TaZ32Y6AhTUp7xG3hvGMXb35mBjohIErmdaQWVV-zd203Khdap56-0p30lyMlDq5AYP1WlxdPQfEmNckJMzl525vPuUQi1bY5e7phDCFx6SbiTH4RxN6V-IbpH0xLE3d5P1Ro; DOMAIN=www.google.com\"")
			.build();
	...
	public void testGetElement() {		
		...
		final AddCookie expectedAddCookie = ImmutableAddCookie.builder()
				.name("Set cookie NID for server www.google.com")
				.cookieName("NID")
