...
public class ConditionsWriter {
	...
	public static void writeXML(final Document document, final Element currentElement, final List<Condition> conditions, final If.Match match) {
	...
	private static String matchValue(If.Match match) {
		if(match == If.Match.ANY) return "1";
		return "0";
	}
}
