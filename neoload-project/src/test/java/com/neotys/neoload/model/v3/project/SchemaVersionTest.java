...
public class SchemaVersionTest {
    ...
    @Test
    public void bean_validation_passes_for_schemaVersion_3_1() {
        final Project project = Project.builder().name("foo").schemaVersion("3.1").build();
        final Validation validation = BEAN_VALIDATOR.validate(project, NeoLoad.class);
        assertTrue("explicit 3.1 must pass: " + validation.getMessage().orElse(""), validation.isValid());
    }
    ...
    public void bean_validation_fails_for_unsupported_schemaVersion() {
        ...
        assertTrue("violation must reference schemaVersion: " + message, message.contains("schema_version"));
    }
