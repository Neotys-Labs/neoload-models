...
public class IOIfTest extends AbstractIOElementsTest {
	...
	public void writeIfRequiredAndOptional() throws IOException {
		...
		write("test-if-required-and-optional-content-assertions", expectedProject);
	}

	@Test
	public void readIfRequiredAndOptionalContentAssertions() throws IOException {
		final Project expectedProject = buildProject(getIfRequiredAndOptional());
		assertNotNull(expectedProject);

		read("test-if-required-and-optional-content-assertions", expectedProject);
	}
}
