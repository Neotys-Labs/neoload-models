...
public class SqlVariableTest {
	...
	public void validateDefaults() {
		...
		assertEquals(ChangePolicyVariable.ChangePolicy.EACH_ITERATION, sqlVariable.getChangePolicy());
		assertEquals(ScopeVariable.Scope.GLOBAL, sqlVariable.getScope());
		assertEquals(OrderVariable.Order.ANY, sqlVariable.getOrder());
		assertEquals(OutOfValueVariable.OutOfValue.CYCLE, sqlVariable.getOutOfValue());
	}
