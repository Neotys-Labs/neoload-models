...
public class SecretVaultVariableTest {
	...
	private static final String MISSING_SECRET_ID = "Data Model is invalid. Violation Number: 1." + System.lineSeparator()
			+ "Violation 1 - Incorrect value for 'secret_id': missing value or value is empty."
			+ System.lineSeparator();

	private static final String MISSING_PROVIDER_ID_AND_SECRET_ID = "Data Model is invalid. Violation Number: 2." + System.lineSeparator()
			+ "Violation 1 - Incorrect value for 'provider_id': missing value or value is empty."
			+ System.lineSeparator()
			+ "Violation 2 - Incorrect value for 'secret_id': missing value or value is empty."
			+ System.lineSeparator();
	...
	public void validateRequiredFields() {
		...
		assertEquals(MISSING_PROVIDER_ID_AND_SECRET_ID, validation.getMessage().get());
		...
		assertFalse(validation.isValid());
		assertEquals(MISSING_SECRET_ID, validation.getMessage().get());
