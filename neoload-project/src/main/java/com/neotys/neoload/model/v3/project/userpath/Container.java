...
@JsonPropertyOrder({Element.NAME, Element.DESCRIPTION, SlaElement.SLA_PROFILE, PacingElement.PACING, Container.STEPS, AssertionsElement.ASSERTIONS})
...
public interface Container extends Step, SlaElement, PacingElement, AssertionsElement {
