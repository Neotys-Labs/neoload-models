...
@JsonPropertyOrder({Variable.NAME, Variable.DESCRIPTION, FileVariable.COLUMN_NAMES, FileVariable.IS_FIRST_LINE_COLUMN_NAMES, FileVariable.START_FROM_LINE,
	FileVariable.DELIMITER, FileVariable.PATH, ChangePolicyVariable.CHANGE_POLICY, ScopeVariable.SCOPE, OrderVariable.ORDER, OutOfValueVariable.OUT_OF_VALUE})
@Value.Immutable
@Value.Style(validationMethod = Value.Style.ValidationMethod.NONE)
public interface FileVariable extends ChangePolicyVariable, ScopeVariable, OrderVariable, OutOfValueVariable {
