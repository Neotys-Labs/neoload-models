...
@JsonPropertyOrder({Variable.NAME, Variable.DESCRIPTION, SqlVariable.DRIVER, SqlVariable.URL, SqlVariable.LOGIN, SqlVariable.PASSWORD,
	SqlVariable.QUERY, SqlVariable.COLUMN_NAMES, ChangePolicyVariable.CHANGE_POLICY, ScopeVariable.SCOPE, OrderVariable.ORDER, OutOfValueVariable.OUT_OF_VALUE})
@Value.Immutable
@Value.Style(validationMethod = Value.Style.ValidationMethod.NONE)
public interface SqlVariable extends ChangePolicyVariable, ScopeVariable, OrderVariable, OutOfValueVariable {
