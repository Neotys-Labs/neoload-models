...
@JsonPropertyOrder({Variable.NAME, Variable.DESCRIPTION, ListVariable.COLUMN_NAMES, ListVariable.VALUES, ListVariable.START_FROM_LINE,
	ChangePolicyVariable.CHANGE_POLICY, ScopeVariable.SCOPE, OrderVariable.ORDER, OutOfValueVariable.OUT_OF_VALUE})
@Value.Immutable
@Value.Style(validationMethod = Value.Style.ValidationMethod.NONE)
public interface ListVariable extends ChangePolicyVariable, ScopeVariable, OrderVariable, OutOfValueVariable {
