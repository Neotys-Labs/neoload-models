...
/**
 * A random think time: the duration is drawn between {@code min} (optional, default {@code 0})
 * and {@code max} (required). Durations are stored in milliseconds or as a {@code ${variable}}.
 */
@Value.Immutable
@Value.Style(validationMethod = Value.Style.ValidationMethod.NONE)
public interface ThinkTimeRandom extends ThinkTime {
	...
	class Builder extends ImmutableThinkTimeRandom.Builder {}
