...
import com.neotys.neoload.model.validation.constraints.RangeCheck.List;
...
public @interface RangeCheck {
	...
	String message() default "{com.neotys.neoload.model.validation.constraints.RangeCheck.message}";
